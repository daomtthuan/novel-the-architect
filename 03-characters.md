...
A modern software developer, reborn — not as an adult, but as a newborn infant at WC0 — into a magical world, retaining full adult memory and reasoning from birth.

### Traits

analytical · curious · pragmatic · protective · stubborn · emotionally restrained · compassionate · uncomfortable with helplessness

### Strengths

systems thinking · engineering · infrastructure · strategy · leadership · learning
...
Primary heroine and emotional center of Season 1.

### Race

Eterna — a long-lived, Light/Time-affinity people. Ages at 0.25× the Human rate; already an adult (~24) when she meets the 15-year-old-bodied Architect.

### Traits

warm · intelligent · perceptive · courageous · compassionate · independent · humorous · challenging
...
Never make Elena passive.

## Iris

### Role

Elena's best friend; later the Son's sword teacher; secondary heroine.

### Race

Human. Born WC3 (age = WC−3). Ages at the same rate as the Architect.
...
Friend → quiet unspoken attraction → deliberate self-withdrawal → chosen family → co-parent → mentor.
...
The protagonist has NO canonical personal name. "The Architect" is a title/epithet acquired later, and specifically distinct from the broader category "Builder." Never create a civilian name for him.
...
These four are visually and psychologically specific because they are the Season 1 heroines. Their appearance, expressions, clothing motifs, and (where applicable) age progression should be tracked in the visual bible.

## Other Characters

Every recurring character should have: canonical visual identity, age range per installment (adjusted for aging rate where relevant), hairstyle, eye color if narratively useful, clothing style, accessories, body language, signature expressions, visual evolution.
