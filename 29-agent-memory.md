# Agent Memory (v6, World Calendar canon)
...
CURRENT INSTALLMENT: (Season 1 / Movie 1 / Movie 2 / Movie 3 / Movie 4)
CURRENT ARC:
CURRENT CHAPTER:
CURRENT WC YEAR:
CURRENT LOCATION:
...
(Populate from: The Architect, Elena, Iris, Seraphine, Isolde, The Teacher, the Son, Mira, The Other Builder, Noah — as relevant to the current installment.)
...
- Iris (adult-only, unresolved, self-withdrawn)
- Seraphine (guilt-driven, permanently refused)
- Isolde (political-then-genuine, permanently refused)
