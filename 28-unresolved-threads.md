...
- final branch stability.

## Thread Status

Each thread must be tagged: OPEN → ACTIVE → PARTIALLY RESOLVED → RESOLVED → INTENTIONALLY UNANSWERED. Not every mystery requires a literal explanation.
