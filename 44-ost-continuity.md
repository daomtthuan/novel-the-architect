# OST Continuity Registry (v6, World Calendar canon)

## Purpose

This file tracks **where reference OST motifs have actually been used** in the narrative.

`43-ost-reference.md` explains what a track means. This file records: first use; installment/WC year/scene; emotional meaning in context; reuse restrictions; callbacks; whether the track is locked, reserved, or reusable.

This is continuity memory, not canon.

---

## Status Values

`REUSABLE` · `LIMITED` · `RESERVED` · `SINGLE-USE` · `LOCKED`
...
**Future callbacks:** Movie 1 — the Son visiting the old home; later installments' historical records/memory.
...
Before assigning an OST:

1. Check `43-ost-reference.md`.
2. Check this registry.
3. Check `19-emotional-memory.md`.
4. Check `20-scene-memory.md`.
5. Verify a reserved/locked track is not being reused.
6. Verify the emotional register matches.
7. Never use an OST merely because a chapter "needs atmosphere."

After a major use, update this registry.
